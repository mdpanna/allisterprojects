...
<head>
    <meta charset="utf-8">
    <title>Meinexecutive - Career</title>
...
<body>
                                ...
                                <div class="details-box">
                                    ...
                                    <div class="btn-box">
                                        <button class="cust_button cust_button-mat btn--5" data-toggle="modal" data-target="#contact_form_btn">
                                            <div class="cust_btn-text"><span>CONTACT US NOW!</span></div>
                                        </button>
    ...
    <section class="career-part  comm_padd">
        <div class="container">
            ...
            <div class="content-box">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $sel="SELECT * FROM $job_post ORDER BY id DESC";
                                ...
                                <div class="col-12">
                                    <div class="card box">
                                        <div class="card-header">
                                            <h4 class="card-title  m-0 p-0"><?php echo $data['title']; ?></h4>
                                            <label class="card-title  m-0 mt-2 ">Publish: <?php echo $data['date']; ?></label>
                                        </div>
                                        <div class="card-body">
                                            <div class="description-box">
                                                <p><?php echo limit_words($data['description'],50).'....'; ?><a href="job_details.php?post_id=<?php echo $data['id']; ?>">See More</a></p>

                                            </div>

                                            <div class="cust_btn-box">
                                                    ...
                                                    <form action="" method="post" enctype="multipart/form-data" id="job_cv_send">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input" id="customFile1" name="cv_file" required>
                                                                <label class="custom-file-label" for="customFile1">Upload CV</label>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="box">
                                        <div class="details-box">
                                            ...
                                            <label class="m-0">Publish: <?php echo $data['date']; ?> </label>
                                        </div>
                                    </div>
                                </div>
                                <?php } } ?>

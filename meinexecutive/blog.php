...
<head>
    <meta charset="utf-8">
    <title>Meinexecutive - Blog</title>
...
John C. Mein - President - Mein Executive Talent,  Mein Executive Talent, Business Development Manager, executive talent solutions  " />    <link rel="canonical" href="https://www.meinexecutive.com" />
...
-->
    ...
    <section class="blog-part blog-part2 comm_padd">
        <div class="container">
            ...
            <div class="content-box">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $sel="SELECT * FROM $blog ORDER BY id ASC";
                    ...
                    <div class="col-lg-4">
                        ...
                        $sel="SELECT * FROM $blog ORDER BY id DESC LIMIT 3";
                        $query=$db2->select($sel);
                        if($query){
                             while($data=$query->fetch_assoc()){
